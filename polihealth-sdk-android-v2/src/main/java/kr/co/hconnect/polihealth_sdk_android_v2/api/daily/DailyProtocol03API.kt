...
import kr.co.hconnect.polihealth_sdk_android_v2.api.dto.response.toProtocol3Response
...
object DailyProtocol03API {
    ...
    suspend fun requestPost(
        ...
        val response = PoliClient.client.post("poli/day/protocol3") {
            setBody(requestBody)
        }.call.attributes[AttributeKey("body")].toString().toProtocol3Response(hrSpO2)
